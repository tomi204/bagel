...
// --- FlipCard Component ---
const IMG_WIDTH = 70;  // Square for coins
const IMG_HEIGHT = 70; // Square for coins
    ...
    return (
        ...
        >
            ...
            >
                {/* Front Face */}
                <div
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-full shadow-lg bg-white p-2"
...
export default function IntroAnimation() {
    ...
    useEffect(() => {
        ...
        const handleWheel = (e: WheelEvent) => {
            ...
            // Allow scroll pass-through at boundaries
            // If at start and scrolling up, or at end and scrolling down, let page scroll
            if ((currentScroll <= 0 && e.deltaY < 0) ||
                (currentScroll >= MAX_SCROLL && e.deltaY > 0)) {
        ...
        const handleTouchMove = (e: TouchEvent) => {
            ...
            if ((currentScroll <= 0 && deltaY < 0) ||
                (currentScroll >= MAX_SCROLL && deltaY > 0)) {
                return;
            }
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    ...
                    <motion.p
                        ...
                        className="mt-4 text-xs font-bold tracking-[0.2em] text-[#FF6B35]"
                    >
                        SCROLL TO EXPLORE
                    </motion.p>
                </div>
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-semibold text-[#2D2D2A] tracking-tight mb-4">
                        Stream Salaries on <span className="text-[#FF6B35]">Ethereum</span>
                    </h2>
                ...
                <div className="relative flex items-center justify-center w-full h-full">
                    {IMAGES.slice(0, TOTAL_IMAGES).map((src, i) => {
                        ...
                        if (introPhase === "scatter") {
                            ...
                            const lineSpacing = 80; // Adjusted for coin images (70px width + 10px gap)
